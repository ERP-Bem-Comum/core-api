...
const main = async (): Promise<void> => {
  ...
  try {
    ...
    console.log('Semeando Acordos de Cooperação Técnica (par_acts)...');
    ...
    await db.insert(schema.parActs).values([
      {
        ...
        name: 'Acordo de Cooperação — Educação Popular',
        email: 'contato@instituto-epv.org',
        cnpj: generateValidCnpj('400000000001'),
        corporateName: 'Instituto EPV de Educação LTDA',
        fantasyName: 'Instituto EPV',
        occupationArea: 'EPV',
        legalRepresentative: 'Ana Oliveira',
        validityStart,
        validityEnd,
      ...
      },
      {
        ...
        name: 'Acordo de Cooperação — Parcerias Comunitárias',
        email: 'parcerias@fundacao-parc.org',
        cnpj: generateValidCnpj('400000000002'),
        corporateName: 'Fundação Parcerias Comunitárias',
        fantasyName: 'Fundação PARC',
        occupationArea: 'PARC',
        legalRepresentative: 'Pedro Ribeiro',
        validityStart,
        validityEnd,
      ...
      {
        id: randomUUID(),
        actNumber: 'ACT-2025-090',
        name: 'Acordo de Cooperação — Desenvolvimento Institucional (encerrado)',
        email: 'contato@ong-ddi.org',
        cnpj: generateValidCnpj('400000000003'),
        corporateName: 'ONG Desenvolvimento e Direitos LTDA',
        fantasyName: 'ONG DDI',
        occupationArea: 'DDI',
        legalRepresentative: 'Lucas Lima',
        validityStart,
        validityEnd,
        hasFinancialTransfer: false,
        active: false,
