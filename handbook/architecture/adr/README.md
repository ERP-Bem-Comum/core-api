...
| [0047](./0047-cross-module-communication-topology.md)          | Topologia de comunicação cross-módulo — discriminador *exibe vs consulta*: read port síncrono (N1) p/ exibir, projeção local (N4) p/ consultar por campo alheio, snapshot p/ congelar, intra-módulo síncrono na tx (N2); estende ADR-0006/0015/0022/0032, generaliza 0043/0045/0046 | **Proposed** | 2026-06-17 |
