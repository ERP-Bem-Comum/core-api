...
No exemplo abaixo utilizamos 2 regiões `br-se1` e `br-ne1` e criamos um provider para cada, adicionando um _alias_ para facilitar o controle dos recursos de block-storage:
