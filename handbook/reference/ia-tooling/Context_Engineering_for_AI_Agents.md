...
organisms = [
    ...
    (
        "Mouse",
        "~24-30 month median lifespan. Full study is 3-year commitment, 
100K+ per 100-mouse cohort. Cre-lox conditionals, inbred strain panels, humanized models. ~85% orthology, best translational predictor.",
    ),
    (
        "Killifish",
