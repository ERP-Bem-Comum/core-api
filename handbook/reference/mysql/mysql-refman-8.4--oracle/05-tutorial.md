...
\subsection*{5.1 Connecting to and Disconnecting from the Server}
...
Your MySQL connection id is 25338 to server version: 8.4.9-standard
...
\subsection*{5.2 Entering Queries}
...
\begin{tabular}{|l|l|}
\hline Prompt & Meaning \\
\hline mysql> & Ready for new query \\
\hline -> & Waiting for next line of multiple-line query \\
\hline '> & Waiting for next line, waiting for completion of a string that began with a single quote ( ' ) \\
\hline "> & Waiting for next line, waiting for completion of a string that began with a double quote (") \\
\hline ˋ> & Waiting for next line, waiting for completion of an identifier that began with a backtick (ˋ) \\
\hline /*> & Waiting for next line, waiting for completion of a comment that began with /* \\
\hline
\end{tabular}
...
The ˋ> prompt is similar to the '> and "> prompts, but indicates that you have begun but not completed a backtick-quoted identifier.

It is important to know what the '>, ">, and ˋ> prompts signify, because if you mistakenly enter an unterminated string, any further lines you type appear to be ignored by mysql-including a line containing QUIT. This can be quite confusing, especially if you do not know that you need to supply the terminating quote before you can cancel the current query.
...
\subsection*{5.3 Creating and Using a Database}
...
\subsection*{5.3.1 Creating and Selecting a Database}
...
![](https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-0283.jpg?height=106&width=99&top_left_y=1034&top_left_x=370)

\section*{Note}

You can see at any time which database is currently selected using SELECT DATABASE( ).

\subsection*{5.3.2 Creating a Table}
...
\hline name & varchar(20) & YES & NULL & \\
\hline owner & varchar(20) & YES & NULL & \\
\hline species & varchar(20) & YES & NULL & \\
\hline sex & char(1) & YES & NULL & \\
\hline birth & date & YES & NULL & \\
\hline death & date & YES & NULL & \\
\hline
\end{tabular}
```
...
\subsection*{5.3.3 Loading Data into a Table}

After creating your table, you need to populate it. The LOAD DATA and INSERT statements are useful for this.

Suppose that your pet records can be described as shown here. (Observe that MySQL expects dates in ' $Y Y Y Y-M M-D D$ ' format; this may differ from what you are used to.)

\begin{tabular}{|l|l|l|l|l|l|}
\hline name & owner & species & sex & birth & death \\
\hline Fluffy & Harold & cat & f & 1993-02-04 & \\
\hline Claws & Gwen & cat & m & 1994-03-17 & \\
\hline Buffy & Harold & dog & f & 1989-05-13 & \\
\hline Fang & Benny & dog & m & 1990-08-27 & \\
\hline Bowser & Diane & dog & m & 1979-08-31 & 1995-07-29 \\
\hline Chirpy & Gwen & bird & f & 1998-09-11 & \\
\hline Whistler & Gwen & bird & & 1997-12-09 & \\
\hline Slim & Benny & snake & m & 1996-04-29 & \\
\hline
\end{tabular}
...
If you created the file on Windows with an editor that uses $\backslash r \backslash n$ as a line terminator, you should use this statement instead:
```
mysql> LOAD DATA LOCAL INFILE '/path/pet.txt' INTO TABLE pet
    LINES TERMINATED BY '\r\n';
```
...
\subsection*{5.3.4 Retrieving Information from a Table}
...
\subsection*{5.3.4.1 Selecting All Data}
...
\begin{tabular}{|l|l|l|l|l|l|}
\hline Fluffy & Harold & cat & f & 1993-02-04 & NULL \\
\hline Claws & Gwen & cat & m & 1994-03-17 & NULL \\
\hline Buffy & Harold & dog & f & 1989-05-13 & NULL \\
\hline Fang & Benny & dog & m & 1990-08-27 & NULL \\
\hline Bowser & Diane & dog & m & 1979-08-31 & 1995-07-29 \\
\hline Chirpy & Gwen & bird & f & 1998-09-11 & NULL \\
\hline Whistler & Gwen & bird & NULL & 1997-12-09 & NULL \\
\hline Slim & Benny & snake & m & 1996-04-29 & NULL \\
\hline Puffball & Diane & hamster & f & 1999-03-30 & NULL \\
\hline
\end{tabular}
...
\subsection*{5.3.4.2 Selecting Particular Rows}
...
\begin{tabular}{|l|l|l|l|l|l|}
$\mid$ Chirpy | Gwen | bird | f & 1998-09-11 | NULL | \\
$\mid$ Puffball | Diane | hamster | f & | 1999-03-30 | NULL |
\end{tabular}
```
...
\subsection*{5.3.4.3 Selecting Particular Columns}
...
\begin{tabular}{|l|l|}
\hline name & birth \\
\hline Fluffy & 1993-02-04 \\
\hline Claws & 1994-03-17 \\
\hline Buffy & 1989-05-13 \\
\hline Fang & 1990-08-27 \\
\hline Bowser & 1989-08-31 \\
\hline Chirpy & 1998-09-11 \\
\hline Whistler & 1997-12-09 \\
\hline Slim & 1996-04-29 \\
\hline Puffball & 1999-03-30 \\
\hline
\end{tabular}
```
...
\subsection*{5.3.4.4 Sorting Rows}
...
\subsection*{5.3.4.5 Date Calculations}
...
\hline name & birth & CURDATE() & age \\
\hline Bowser & 1989-08-31 & 2003-08-19 & 13 \\
\hline Buffy & 1989-05-13 & 2003-08-19 & 14 \\
\hline Chirpy & 1998-09-11 & 2003-08-19 & 4 \\
\hline Claws & 1994-03-17 & 2003-08-19 & 9 \\
\hline Fang & 1990-08-27 & 2003-08-19 & 12 \\
\hline Fluffy & 1993-02-04 & 2003-08-19 & 10 \\
\hline Puffball & 1999-03-30 & 2003-08-19 & 4 \\
\hline Slim & 1996-04-29 & 2003-08-19 & 7 \\
\hline Whistler & 1997-12-09 & 2003-08-19 & 5 \\
\hline
\end{tabular}
```
...
\begin{tabular}{|l|l|l|l|}
\hline name & birth & death & age \\
\hline Bowser & 1989-08-31 & 1995-07-29 & 5 \\
\hline
\end{tabular}
```
...
\begin{tabular}{|l|l|l|}
\hline name & birth & MONTH(birth) \\
\hline Fluffy & 1993-02-04 & 2 \\
\hline Claws & 1994-03-17 & 3 \\
\hline Buffy & 1989-05-13 & 5 \\
\hline Fang & 1990-08-27 & 8 \\
\hline Bowser & 1989-08-31 & 8 \\
\hline Chirpy & 1998-09-11 & 9 \\
\hline Whistler & 1997-12-09 & 12 \\
\hline Slim & 1996-04-29 & 4 \\
\hline Puffball & 1999-03-30 & 3 \\
\hline
\end{tabular}
```
...
\subsection*{5.3.4.6 Working with NULL Values}
...
\subsection*{5.3.4.7 Pattern Matching}
...
![](https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-0293.jpg?height=70&width=954&top_left_y=312&top_left_x=351)
```
+--------+--------+---------+------+------------+-------+
```
...
![](https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-0293.jpg?height=68&width=926&top_left_y=657&top_left_x=351)
```
...
![](https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-0293.jpg?height=68&width=940&top_left_y=1027&top_left_x=351)
```
+-------+--------+---------+------+------------+------+
```
...
- * matches zero or more instances of the thing preceding it. For example, $x$ * matches any number of × characters, $[0-9]^{*}$ matches any number of digits, and .* matches any number of anything.
...
To find names beginning with b , use $\wedge$ to match the beginning of the name:
```
...
\hline name & owner & species & sex & birth & death \\
\hline Claws & Gwen & cat & m & 1994-03-17 & NULL \\
\hline Bowser & Diane & dog & m & 1989-08-31 & 1995-07-29 \\
\hline Whistler & Gwen & bird & NULL & 1997-12-09 & NULL \\
\hline
\end{tabular}
```
...
\begin{tabular}{l|l|l|l|l|l|l|} 
Claws | Gwen | cat | m | & m & 1994-03-17 | & NULL | \\
| Buffy | Harold | dog | & f & 1989-05-13 | & NULL | \\
& & &
\end{tabular}
```
...
\subsection*{5.3.4.8 Counting Rows}
...
\subsection*{5.3.4.9 Using More Than one Table}
...
\begin{tabular}{|l|l|l|l|}
\hline name & date & type & remark \\
\hline Fluffy & 1995-05-15 & litter & 4 kittens, 3 female, 1 male \\
\hline Buffy & 1993-06-23 & litter & 5 puppies, 2 female, 3 male \\
\hline Buffy & 1994-06-19 & litter & 3 puppies, 3 female \\
\hline Chirpy & 1999-03-21 & vet & needed beak straightened \\
\hline Slim & 1997-08-03 & vet & broken rib \\
\hline Bowser & 1991-10-12 & kennel & \\
\hline Fang & 1991-10-12 & kennel & \\
\hline Fang & 1998-08-28 & birthday & Gave him a new chew toy \\
\hline Claws & 1998-03-17 & birthday & Gave him a new flea collar \\
\hline Whistler & 1998-12-09 & birthday & First birthday \\
\hline
\end{tabular}
...
![](https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-0298.jpg?height=60&width=707&top_left_y=1069&top_left_x=287)
```
| Buffy | f | Fang | m | dog |
+---------+------+-------+------+---------+
```
...
\subsection*{5.4 Getting Information About Databases and Tables}
...
The name of the column in the output produced by this statement is always Tables_in_db_name, where $d b \_n a m e$ is the name of the database. See Section 15.7.7.39, "SHOW TABLES Statement", for more information.
...
\subsection*{5.5 Using mysql in Batch Mode}
...
\subsection*{5.6 Examples of Common Queries}
...
\subsection*{5.6.1 The Maximum Value for a Column}
...
\subsection*{5.6.2 The Row Holding the Maximum of a Certain Column}
...
![](https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-0301.jpg?height=122&width=97&top_left_y=2275&top_left_x=370)

\section*{Note}

If there were several most expensive articles, each with a price of 19.95, the LIMIT solution would show only one of them.

\subsection*{5.6.3 Maximum of Column per Group}
...
\subsection*{5.6.4 The Rows Holding the Group-wise Maximum of a Certain Column}
...
\subsection*{5.6.5 Using User-Defined Variables}
...
\subsection*{5.6.6 Using Foreign Keys}
...
(ˋtestˋ.ˋchildˋ, CONSTRAINT ˋchild_ibfk_1ˋ FOREIGN KEY (ˋparent_idˋ)
REFERENCES ˋparentˋ (ˋidˋ))
```
...
![](https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-0304.jpg?height=109&width=342&top_left_y=2567&top_left_x=287)
```
+------+-----------+
```
...
\subsection*{5.6.7 Searching on Two Keys}

An OR using a single key is well optimized, as is the handling of AND.
The one tricky case is that of searching on two different keys combined with 0R:
```
...
\subsection*{5.6.8 Calculating Visits Per Day}
...
\subsection*{5.6.9 Using AUTO_INCREMENT}
...
![](https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-0307.jpg?height=106&width=97&top_left_y=1400&top_left_x=370)
...
\subsection*{5.7 Using MySQL with Apache}
