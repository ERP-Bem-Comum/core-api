\section*{Chapter 18 Alternative Storage Engines}
Table of Contents
...
\section*{MySQL 8.4 Supported Storage Engines}
...
\caption{Table 18.1 Storage Engines Feature Summary}
\begin{tabular}{|l|l|l|l|l|l|}
\hline Feature & MyISAM & Memory & InnoDB & Archive & NDB \\
\hline B-tree indexes & Yes & Yes & Yes & No & No \\
\hline Backup/point-in-time recovery (note 1) & Yes & Yes & Yes & Yes & Yes \\
\hline Cluster database support & No & No & No & No & Yes \\
\hline Clustered indexes & No & No & Yes & No & No \\
\hline Compressed data & Yes (note 2) & No & Yes & Yes & No \\
\hline Data caches & No & N/A & Yes & No & Yes \\
\hline Encrypted data & Yes (note 3) & Yes (note 3) & Yes (note 4) & Yes (note 3) & Yes (note 5) \\
\hline Foreign key support & No & No & Yes & No & Yes \\
\hline Full-text search indexes & Yes & No & Yes (note 6) & No & No \\
\hline Geospatial data type support & Yes & No & Yes & Yes & Yes \\
\hline Geospatial indexing support & Yes & No & Yes (note 7) & No & No \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{|l|l|l|l|l|l|}
\hline Feature & MyISAM & Memory & InnoDB & Archive & NDB \\
\hline Hash indexes & No & Yes & No (note 8) & No & Yes \\
\hline Index caches & Yes & N/A & Yes & No & Yes \\
\hline Locking granularity & Table & Table & Row & Row & Row \\
\hline MVCC & No & No & Yes & No & No \\
\hline Replication support (note 1) & Yes & Limited (note 9) & Yes & Yes & Yes \\
\hline Storage limits & 256 TB & RAM & 64 TB & None & 384EB \\
\hline T-tree indexes & No & No & No & No & Yes \\
\hline Transactions & No & No & Yes & No & Yes \\
\hline Update statistics for data dictionary & Yes & Yes & Yes & Yes & Yes \\
\hline
\end{tabular}
...
\subsection*{18.1 Setting the Storage Engine}
...
\hline Clustered indexes & No \\
\hline Compressed data & Yes (Compressed MyISAM tables are supported only when using the compressed row format. Tables using the compressed row format with MyISAM are read only.) \\
\hline Data caches & No \\
\hline Encrypted data & Yes (Implemented in the server via encryption functions.) \\
\hline Foreign key support & No \\
\hline Full-text search indexes & Yes \\
\hline Geospatial data type support & Yes \\
\hline Geospatial indexing support & Yes \\
\hline Hash indexes & No \\
\hline
\end{tabular}
\end{table}
...
- There is a limit of $\left(2^{32}\right)^{2}(1.844 \mathrm{E}+19)$ rows in a MyISAM table.
...
- The sum of the lengths of the VARCHAR and CHAR columns in a table may be up to 64 KB .
...
\subsection*{18.2.1 MyISAM Startup Options}
...
\begin{table}
\captionsetup{labelformat=empty}
\caption{Table 18.3 MyISAM Option and Variable Reference}
\begin{tabular}{|l|l|l|l|l|l|}
\hline Name & Option File & System Var & Status Var & Var Scope & Dynamic \\
\hline bulk_insert_butyers_size & Yes & Yes & & Both & Yes \\
\hline concurrent_inseres & Yes & Yes & & Global & Yes \\
\hline delay_key_writees & Yes & Yes & & Global & Yes \\
\hline have_rtree_keys & & Yes & & Global & No \\
\hline key_buffer_size es & Yes & Yes & & Global & Yes \\
\hline log-isam $\quad$ Yes & Yes & & & & \\
\hline myisam-block-size & Yes & & & & \\
\hline myisam_data_reister_size & Yes & Yes & & Global & Yes \\
\hline myisam_max_\&cs_file_size & Yes & Yes & & Global & Yes \\
\hline myisam_mmapYesze & Yes & Yes & & Global & No \\
\hline myisam_recoveręsptions & Yes & Yes & & Global & No \\
\hline myisam_sort_byrer_size & Yes & Yes & & Both & Yes \\
\hline myisam_stats_Yerthod & Yes & Yes & & Both & Yes \\
\hline myisam_use_nyresp & Yes & Yes & & Global & Yes \\
\hline tmp_table_sizeYes & Yes & Yes & & Both & Yes \\
\hline
\end{tabular}
\end{table}
...
![](https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-3332.jpg?height=126&width=101&top_left_y=1745&top_left_x=340)
...
\subsection*{18.2.2 Space Needed for Keys}
...
\subsection*{18.2.3 MyISAM Table Storage Formats}
...
\subsection*{18.2.3.1 Static (Fixed-Length) Table Characteristics}
...
\subsection*{18.2.3.2 Dynamic Table Characteristics}
...
\subsection*{18.2.3.3 Compressed Table Characteristics}
...
\subsection*{18.2.4 MyISAM Table Problems}
...
\subsection*{18.2.4.1 Corrupted MyISAM Tables}
...
\subsection*{18.2.4.2 Problems from Tables Not Being Closed Properly}
...
\subsection*{18.3 The MEMORY Storage Engine}
...
\begin{table}
\captionsetup{labelformat=empty}
\caption{Table 18.4 MEMORY Storage Engine Features}
\begin{tabular}{|l|l|}
\hline Feature & Support \\
\hline B-tree indexes & Yes \\
\hline
...
\hline Cluster database support & No \\
\hline Clustered indexes & No \\
\hline Compressed data & No \\
\hline Data caches & N/A \\
\hline Encrypted data & Yes (Implemented in the server via encryption functions.) \\
\hline Foreign key support & No \\
\hline Full-text search indexes & No \\
\hline Geospatial data type support & No \\
\hline Geospatial indexing support & No \\
\hline Hash indexes & Yes \\
\hline Index caches & N/A \\
\hline Locking granularity & Table \\
\hline MVCC & No \\
\hline Replication support (Implemented in the server, rather than in the storage engine.) & Limited (See the discussion later in this section.) \\
\hline Storage limits & RAM \\
\hline T-tree indexes & No \\
\hline Transactions & No \\
\hline Update statistics for data dictionary & Yes \\
\hline
...
\section*{When to Use MEMORY or NDB Cluster}
...
\section*{Characteristics of MEMORY Tables}
...
\section*{DDL Operations for MEMORY Tables}
...
\section*{User-Created and Temporary Tables}

MEMORY table contents are stored in memory, which is a property that MEMORY tables share with internal temporary tables that the server creates on the fly while processing queries. However, the two
types of tables differ in that MEMORY tables are not subject to storage conversion, whereas internal temporary tables are:
...
\section*{MEMORY Tables and Replication}
...
\subsection*{18.4 The CSV Storage Engine}
...
\subsection*{18.4.1 Repairing and Checking CSV Tables}
...
\subsection*{18.4.2 CSV Limitations}
...
\subsection*{18.5 The ARCHIVE Storage Engine}
...
\begin{table}
\captionsetup{labelformat=empty}
\caption{Table 18.5 ARCHIVE Storage Engine Features}
\begin{tabular}{|l|l|}
\hline Feature & Support \\
\hline B-tree indexes & No \\
\hline Backup/point-in-time recovery (Implemented in the server, rather than in the storage engine.) & Yes \\
\hline Cluster database support & No \\
\hline Clustered indexes & No \\
...
\hline Geospatial indexing support & No \\
\hline Hash indexes & No \\
\hline Index caches & No \\
\hline Locking granularity & Row \\
\hline MVCC & No \\
\hline Replication support (Implemented in the server, rather than in the storage engine.) & Yes \\
\hline Storage limits & None \\
\hline T-tree indexes & No \\
\hline Transactions & No \\
\hline Update statistics for data dictionary & Yes \\
\hline
...
\subsection*{18.6 The BLACKHOLE Storage Engine}
...
\begin{figure}
\captionsetup{labelformat=empty}
\caption{Figure 18.1 Replication using BLACKHOLE for Filtering}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-3346.jpg?height=693&width=1557&top_left_y=374&top_left_x=303}
\end{figure}
...
\section*{Blackhole Engine and Auto Increment Columns}
...
\subsection*{18.7 The MERGE Storage Engine}
...
When you create a MERGE table, MySQL creates a .MRG file on disk that contains the names of the underlying MyISAM tables that should be used as one. The table format of the MERGE table is stored
in the MySQL data dictionary. The underlying tables do not have to be in the same database as the MERGE table.
...
![](https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-3348.jpg?height=118&width=99&top_left_y=479&top_left_x=306)
...
\subsection*{18.7.1 MERGE Table Advantages and Disadvantages}
...
\subsection*{18.7.2 MERGE Table Problems}
...
- The INSERT_METHOD table option for a MERGE table indicates which underlying MyISAM table to use for inserts into the MERGE table. However, use of the AUTO_INCREMENT table option for that MyISAM
...
- The maximum number of rows in a MERGE table is $2^{64}(\sim 1.844 \mathrm{E}+19$; the same as for a MyISAM table). It is not possible to merge multiple MyISAM tables into a single MERGE table that would have more than this number of rows.
...
\subsection*{18.8 The FEDERATED Storage Engine}
...
\subsection*{18.8.1 FEDERATED Storage Engine Overview}
...
\begin{figure}
\captionsetup{labelformat=empty}
\caption{Figure 18.2 FEDERATED Table Structure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-3353.jpg?height=789&width=773&top_left_y=413&top_left_x=349}
\end{figure}
...
\subsection*{18.8.2 How to Create FEDERATED Tables}
...
![](https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-3354.jpg?height=122&width=108&top_left_y=607&top_left_x=301)

\section*{Important}

When you create the local table it must have an identical field definition to the remote table.
![](https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-3354.jpg?height=123&width=99&top_left_y=794&top_left_x=306)
...
\subsection*{18.8.2.1 Creating a FEDERATED Table Using CONNECTION}
...
![](https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-3354.jpg?height=120&width=99&top_left_y=1738&top_left_x=306)
...
\subsection*{18.8.2.2 Creating a FEDERATED Table Using CREATE SERVER}
...
\hline Description & CONNECTION string & CREATE SERVER option & mysql.servers column \\
\hline Connection scheme & scheme & wrapper_name & Wrapper \\
\hline Remote user & user_name & USER & Username \\
\hline Remote password & password & PASSWORD & Password \\
\hline Remote host & host_name & HOST & Host \\
\hline Remote port & port_num & PORT & Port \\
\hline Remote database & db_name & DATABASE & Db \\
\hline
\end{tabular}

\subsection*{18.8.3 FEDERATED Storage Engine Notes and Tips}
...
\subsection*{18.8.4 FEDERATED Storage Engine Resources}
...
\subsection*{18.9 The EXAMPLE Storage Engine}
...
\subsection*{18.10 Other Storage Engines}
...
\subsection*{18.11 Overview of MySQL Storage Engine Architecture}
...
\begin{figure}
\captionsetup{labelformat=empty}
\caption{Figure 18.3 MySQL Architecture with Pluggable Storage Engines}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/3d8cf8cc-cc66-4dae-b696-9a5a902951f8-3358.jpg?height=1075&width=1011&top_left_y=1589&top_left_x=285}
\end{figure}
...
\subsection*{18.11.1 Pluggable Storage Engine Architecture}

MySQL Server uses a pluggable storage engine architecture that enables storage engines to be loaded into and unloaded from a running MySQL server.

\section*{Plugging in a Storage Engine}
...
\section*{Unplugging a Storage Engine}
...
\subsection*{18.11.2 The Common Database Server Layer}
