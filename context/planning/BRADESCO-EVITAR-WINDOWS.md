...
> _"Estou retomando a pesquisa documentada em `context/planning/BRADESCO-EVITAR-WINDOWS.md`. Recebi as seguintes respostas: [colar texto]. Me ajuda a interpretar e decidir entre os cenários 1, 2 ou 3."_
