...
- **Job queue (BullMQ/Valkey) segue diferida.** O gatilho do [ADR-0030](../../handbook/architecture/adr/0030-inprocess-rate-limit-store-defer-valkey.md) (`Proposed`) exige o ADR virar `Accepted` **ou** existirem 3+ jobs com dependência entre si. Há 6 jobs, todos independentes — contagem não dispara o gatilho, fanout dispararia. Até lá, cron + one-shot; o resto é YAGNI.
