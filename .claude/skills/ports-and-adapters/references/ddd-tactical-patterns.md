...
export type ContratoEvento =
  | { readonly type: 'ContratoMaeCriado';        readonly contratoId: ContratoId; readonly ocorridoEm: Date; /* ... */ }
  | { readonly type: 'EstadoContratualAtualizado'; readonly contratoId: ContratoId; readonly ocorridoEm: Date; /* ... */ }
  | { readonly type: 'ContratoEncerrado';        readonly contratoId: ContratoId; readonly ocorridoEm: Date; /* ... */ };
```
...
export const calcularLimiteAprovacao = (
  ...
  programa: Programa,
  usuario: UsuarioRef,
): Moeda => { /* ... pura, sem repo, sem effects ... */ };
```
