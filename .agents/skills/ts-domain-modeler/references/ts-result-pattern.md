...
export type MoedaError = 'moeda-valor-nao-inteiro' | 'moeda-valor-negativo';
...
// Exemplo
const r = flatMap(Moeda.fromCentavos(100), (m) =>
  Moeda.subtrair(m, Moeda.fromCentavos(200)._unsafeOk),
);
```
...
export const findById = async (
  id: ContratoId,
): Promise<Result<Contrato | null, 'db-unavailable'>> => {
  try {
