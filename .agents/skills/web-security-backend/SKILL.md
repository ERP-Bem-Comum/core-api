...
- **TLS no BFF (ADR-0005/0025):** core-api é HTTP interno. ❌ Não reportar "sem TLS/HTTPS"; ❌ não recomendar HSTS; cookies `Secure` só atrás do proxy (flag de ambiente, nunca incondicional). _(Mesma guidance da skill openai best-practices: "be very careful about not reporting lack of TLS as a security issue".)_
